...
<body>
    ...
    <header>
        <div class="top">
            <img class="logo" src="img/logo_google.png" alt="">
    ...
    <main>
        <?php foreach ($faqs as $faq) {?>
            ...
            <?php foreach ($faq['answers'] as $key => $answer) { 
                if (is_array($answer)) { ?>
                    <ol>
                    <?php foreach ($answer as $incepted) { ?>
                        <?php if (is_array($incepted)) { ?> 
                            <ol>
                                <?php foreach ($incepted as $double) { ?>
                                    <li> <?php echo $double; } ?></li>
                            </ol>  
                        <?php } else {?>
                        <li> <?php echo $incepted; } ?> </li>
